class AppException implements Exception {
  ...
  factory AppException.from(dynamic e) {
    ...
    if (errorStr.contains('socketexception') || errorStr.contains('failed host lookup')) {
      return AppException('Pas de connexion internet. Veuillez vérifier votre réseau.', originalError: e);
    }
    if (errorStr.contains('postgrestexception')) {
      return AppException('Impossible de charger les données pour le moment.', originalError: e);
    }
